        ...
        <main>
          ...
          <div className="flex flex-col md:flex-row items-start justify-between mb-16 mt-8 gap-8">
            <div className="md:w-1/2">
              <h1 className="text-5xl font-bold text-blue-900 mb-4">
                Unlock <span className="text-orange-600">Your Career</span>
              </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 mb-16">
            ...
            <Link href="/jobs" passHref>
              <div className="bg-blue-500 rounded-2xl p-6 flex items-center justify-between shadow-5xl cursor-pointer">
                <div>
            ...
            <Link href="/internship" passHref>
              <div className="bg-green-400 rounded-2xl p-6 flex items-center justify-between shadow-5xl cursor-pointer">
                <div>
            ...
            <Link href="/mentorship" passHref>
              <div className="bg-orange-400 rounded-2xl p-6 flex items-center justify-between shadow-5xl cursor-pointer">
                <div>
                  ...
                  <div className="flex items-center mt-2">
                    <span className="text-xs bg-white rounded-xl px-2 py-1">
                      2000+ Mentors
                    </span>
                  </div>
                </div>
          ...
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-800 mb-8">
              Who's using <span className="text-orange-700">@ Talent</span>
              <span className="text-blue-950">Max?</span>
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Students and Professionals */}
              <div className="border border-gray-200 rounded-2xl p-6 flex items-center bg-[#e2e2dd]">
              ...
              <div className="border border-gray-200 rounded-2xl p-6 flex items-center bg-[#e2e2dd]">
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 text-sm">
                    Partner, Nurture, and Place Future Talent.
                  </p>
                </div>
                <div className="relative h-28 w-28">
                  <Image
