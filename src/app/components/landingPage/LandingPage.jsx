  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <Head>
        ...
        <meta
          name="description"
          content="Explore opportunities from across the globe"
        />
      ...
      <main>
        ...
        <div className="flex flex-col md:flex-row items-start justify-between mb-16 mt-8 gap-8">
          <div className="md:w-1/2">
            <h1 className="text-5xl font-bold text-blue-900 mb-4 "> Unlock 
             <span className="text-orange-600"> Your Career</span>
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 mb-16">
          ...
          {/* Mentorships Card */}
          <div className="bg-orange-400 rounded-2xl p-6 flex items-center justify-between shadow-5xl">
            <div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-800 mb-8">
            Who's using <span className='text-orange-700'> @ Talent </span><span className='text-blue-950'>Max ?</span>
          </h2>
